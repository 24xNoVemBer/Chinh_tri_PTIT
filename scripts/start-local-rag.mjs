...
if (!['legacy-v1', 'top5-v2', 'expanded-v3', 'definition-v4'].includes(retrievalProfile)) {
  throw new Error('RAG_RETRIEVAL_PROFILE: legacy-v1 | top5-v2 | expanded-v3 | definition-v4')
}
if (mode === 'openai') {
